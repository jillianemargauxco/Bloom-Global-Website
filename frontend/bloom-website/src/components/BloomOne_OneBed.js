                ...
                <div className="ftco-footer-widget mb-4">
                  ...
                  <div className="block-23 mb-3">
                    <ul>
                      ...
                      <li><a href="#"><span className="icon icon-phone" /><span className="text">+63917 542 5666</span></a></li>
                      <li><a href="#"><span className="icon icon-envelope pr-4" /><span className="text">ask@bloomglobalestate.com</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
...
export default BloomOne_OneBed;
